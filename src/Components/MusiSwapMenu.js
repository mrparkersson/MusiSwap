...
import something from "../JSONFILES/myDummyData.json";
          ...
          <Card.Body className="musiswapmenu">
            ...
            {something.map((x) => (
              <div className="itemsmenu">
                <Link to="/musiswapchart" className="listbutton">
                  <img
                    alt="musi swap images"
                    src={chart}
                    className="chartimg"
                  />
                  {x.homepage.chart}
