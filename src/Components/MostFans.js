              ...
              {data.map((recievedData) => (
                <table>
                  <tr>
                    ...
                    <th>
                      <h2 className="mostprice">{recievedData.amount.price}</h2>
                    </th>
                  </tr>
                  <tr>
                    <th>
